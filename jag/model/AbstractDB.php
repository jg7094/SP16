...
abstract class AbstractDB {
     ...
     * @return type Boolean
     */
    public static function modify($sql, array $params = array()) {
    ...
    public static abstract function get(array $idizdelek);
    ...
    public static abstract function delete(array $idizdelek);
}
